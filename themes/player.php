...
<body id="player_top">
  <main id="player_main">
    ...
    <div id="photo_filter">    
        <div class="pl_ctrl_1">1
        <div class="tm_wrapp">
        <button class="tm_up">UP</button>
        ...
        <button class="tm_down">DOWN</button>
        </div>
        <button class="plLeft_btn_1">左</button>
        <button class="plRight_btn_1">右</button>
        </div>

        <div class="pl_ctrl_2">2
        <div class="pl_wrapp">
        ...
        <button class="plLeft_btn_2">左</button>
        <button class="plRight_btn_2">右</button>
        </div>

        <div class="pl_ctrl_3">3
        <div class="fl_wrapp">
        <button class="fl_cl">CLEAR</button>
        <button class="fl_up">UP</button>
        ...
        <button class="fl_dw">DW</button>
        </div>
        <button class="plLeft_btn_3">左</button>
        <button class="plRight_btn_3">右</button>
        </div>
