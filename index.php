<?php 
  // テーマ選択に備えあらかじめセッションにディレクトリ名をセット
  session_start();
...
<head prefix="og:http://ogp.me/ns#">
  <!-- Google Tag Manager -->
  <script>
    (function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s),dl=l!='dataLayer'?'&l='+l:'';j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);})(window,document,'script','dataLayer','GTM-TRD8H7V');
  </script>
...
<noscript>
  <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TRD8H7V"height="0" width="0" style="display:none;:hidden"></iframe>
</noscript>
<!-- End Google Tag Manager (noscript) -->
  ...
  <button id="top_menu" class="d_non btn hover" ontouchstart="">
    <span>menu</span>
  ...
  <main id="top_main" class="row">
    <section class="inner">
      <h1>Calm ＆ Peace of mind-<br>...and Healing to You.</h1>
      <P class="lead side">Calmyou(カーミュー)は癒しにつながる様々なジャンルの画像を、オンラインで利用できるデジタルフォトフレームです。日常のほんのひとときに、ささやかな安らぎをあなたにお届けします。</P>
    </section>
