        ...
        <div class="side form_wrapper">
          <div class="flow_area">
            <ul>
              ...
              <li>確認</li>
              <li><img src="../common/img/el_parts/right_triangle.svg" alt=""></li>
              <li class="current">送信</li>
            </ul>
            <p class="contact_notice">お問い合わせいただきありがとうございます。メッセージを送信しました。引き続き、当サイトのコンテンツをお楽しみください。</p>
          </div>
          <div class="thanks_btn_wrapper">
            <p style="padding:0;"><a href="../">TOP</a></p>
          </div>
        </div>
      </div>
    </section>
